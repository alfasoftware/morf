...
public class TestOracleMetaDataProvider {
   ...
   * @throws SQLException
   */
  private PreparedStatement mockGetTableKeysQuery(int numberOfResultRows, boolean failPKConstraintCheck) throws SQLException {
    ...
    public ResultSet answer(final InvocationOnMock invocation) throws Throwable {
      ...
      if (isConstraintQuery) {
        ...
        if (failPKConstraintCheck) {
          ...
          when(resultSet.getString(4)).thenReturn("UNIQUE");
        }
      } else {
