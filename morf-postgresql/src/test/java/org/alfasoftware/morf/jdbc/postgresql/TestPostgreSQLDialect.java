...
public class TestPostgreSQLDialect extends AbstractSqlDialectTest {
  ...
  public void testInputFieldInNativeMergeMode() {
    ...
    org.alfasoftware.morf.sql.MergeStatement mergeStatement = org.alfasoftware.morf.sql.MergeStatement.merge()
      ...
      .ifUpdating(org.alfasoftware.morf.sql.MergeStatement.InputField.inputField("bar"))
      .build();
    ...
    org.junit.Assert.assertTrue("SQL should contain 's.bar' for InputField in native MERGE mode", 
                                 sql.contains("s.bar"));
    org.junit.Assert.assertFalse("SQL should not contain 'EXCLUDED.bar' in native MERGE mode", 
  ...
  public void testInputFieldInInsertOnConflictMode() {
    ...
    org.junit.Assert.assertTrue("SQL should contain 'EXCLUDED.bar' for InputField in INSERT...ON CONFLICT mode", 
                                 sql.contains("EXCLUDED.bar"));
    org.junit.Assert.assertFalse("SQL should not contain 's.bar' in INSERT...ON CONFLICT mode", 
                                  sql.contains("s.bar"));
  }
}
