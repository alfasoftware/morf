...
public class TestPostgreSQLDialect extends AbstractSqlDialectTest {
  ...
  public void testShouldUseNativeMergeWithVersion15() {
    ...
    // Then
    org.junit.Assert.assertTrue("Should use native MERGE for PostgreSQL 15", result);
  }
  ...
  public void testShouldUseNativeMergeWithVersion16() {
    ...
    // Then
    org.junit.Assert.assertTrue("Should use native MERGE for PostgreSQL 16", result);
  }
  ...
  public void testShouldUseNativeMergeWithVersion14() {
    ...
    // Then
    org.junit.Assert.assertFalse("Should not use native MERGE for PostgreSQL 14", result);
  }
  ...
  public void testShouldUseNativeMergeWithVersion13() {
    ...
    // Then
    org.junit.Assert.assertFalse("Should not use native MERGE for PostgreSQL 13", result);
  }
  ...
  public void testShouldUseNativeMergeWithMissingVersion() {
    ...
    // Then
    org.junit.Assert.assertFalse("Should not use native MERGE when version is missing", result);
  }
  ...
  public void testShouldUseNativeMergeWithNoMetadataProvider() {
    ...
    // Then
    org.junit.Assert.assertFalse("Should not use native MERGE when metadata provider is not available", result);
  }
  ...
  public void testShouldUseNativeMergeWithInvalidVersionFormat() {
    ...
    // Then
    org.junit.Assert.assertFalse("Should not use native MERGE when version format is invalid", result);
  }
}
