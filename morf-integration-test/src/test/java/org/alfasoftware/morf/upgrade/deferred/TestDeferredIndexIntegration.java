...
public class TestDeferredIndexIntegration {
  ...
  public void testExecutorCompletesAndIndexExistsInSchema() {
    ...
    DeferredIndexExecutor executor = new DeferredIndexExecutorImpl(new DeferredIndexOperationDAOImpl(connectionResources), connectionResources, new SqlScriptExecutorProvider(connectionResources), config, new DeferredIndexExecutorServiceFactory.Default());
  ...
  public void testExecutorIdempotencyOnCompletedQueue() {
    ...
    DeferredIndexExecutor executor1 = new DeferredIndexExecutorImpl(new DeferredIndexOperationDAOImpl(connectionResources), connectionResources, new SqlScriptExecutorProvider(connectionResources), config, new DeferredIndexExecutorServiceFactory.Default());
    ...
    DeferredIndexExecutor executor2 = new DeferredIndexExecutorImpl(new DeferredIndexOperationDAOImpl(connectionResources), connectionResources, new SqlScriptExecutorProvider(connectionResources), config, new DeferredIndexExecutorServiceFactory.Default());
  ...
  public void testRecoveryResetsStaleOperationThenExecutorCompletes() {
    ...
    new DeferredIndexRecoveryServiceImpl(new DeferredIndexOperationDAOImpl(connectionResources), connectionResources, recoveryConfig).recoverStaleOperations();
    ...
    DeferredIndexExecutor executor = new DeferredIndexExecutorImpl(new DeferredIndexOperationDAOImpl(connectionResources), connectionResources, new SqlScriptExecutorProvider(connectionResources), execConfig, new DeferredIndexExecutorServiceFactory.Default());
    executor.execute().join();
