 ...
 */
@Sequence(90020)
@UUID("d1f00002-0002-0002-0002-000000000020")
public class ChangeDeferredToNonDeferred implements UpgradeStep {

  @Override
  public String getJiraId() { return "TEST-20"; }

  @Override
  public String getDescription() { return "Change Product_Name_1 from deferred to non-deferred"; }
