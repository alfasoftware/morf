...
public class TestDeployedIndexTracker {
  ...
  public void testMarkFailedTransitionsToFailed() {
    ...
    java.util.List<org.alfasoftware.morf.upgrade.deployed.DeployedIndexEntry> pending = tracker.getPendingIndexes();
    assertEquals(1, pending.size());
    assertEquals("Unique constraint violation", pending.get(0).getErrorMessage());
    assertEquals(org.alfasoftware.morf.upgrade.deployed.DeployedIndexStatus.FAILED, pending.get(0).getStatus());
  }
