...
public class RedshiftMetaDataProvider extends DatabaseMetaDataProvider {
  ...
  private static final Log log = LogFactory.getLog(RedshiftMetaDataProvider.class);

  private static final Pattern REALNAME_COMMENT_MATCHER = Pattern.compile(".*"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":\\[([^\\]]*)\\](/TYPE:\\[([^\\]]*)\\])?.*");
