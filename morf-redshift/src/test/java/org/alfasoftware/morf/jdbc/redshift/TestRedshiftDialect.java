...
/**
 * Tests SQL statements generated for Redshift.
 *
 * @author Copyright (c) Alfa Financial Software 2019
 */
public class TestRedshiftDialect extends AbstractSqlDialectTest {
  ...
  protected List<String> expectedCreateTableStatements() {
    return Arrays
        .asList(
          ...
          "COMMENT ON TABLE testschema.Test IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[Test]'",
          "COMMENT ON COLUMN testschema.Test.id IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[id]/TYPE:[BIG_INTEGER]'",
          "COMMENT ON COLUMN testschema.Test.version IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[version]/TYPE:[INTEGER]'",
          "COMMENT ON COLUMN testschema.Test.stringField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[stringField]/TYPE:[STRING]'",
          "COMMENT ON COLUMN testschema.Test.intField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[intField]/TYPE:[INTEGER]'",
          "COMMENT ON COLUMN testschema.Test.floatField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[floatField]/TYPE:[DECIMAL]'",
          "COMMENT ON COLUMN testschema.Test.dateField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[dateField]/TYPE:[DATE]'",
          "COMMENT ON COLUMN testschema.Test.booleanField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[booleanField]/TYPE:[BOOLEAN]'",
          "COMMENT ON COLUMN testschema.Test.charField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[charField]/TYPE:[STRING]'",
          "COMMENT ON COLUMN testschema.Test.blobField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[blobField]/TYPE:[BLOB]'",
          "COMMENT ON COLUMN testschema.Test.bigIntegerField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[bigIntegerField]/TYPE:[BIG_INTEGER]'",
          "COMMENT ON COLUMN testschema.Test.clobField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[clobField]/TYPE:[CLOB]'",
          "CREATE UNIQUE INDEX Test_NK ON testschema.Test (stringField)",
          "COMMENT ON INDEX Test_NK IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[Test_NK]'",
          "CREATE UNIQUE INDEX Test_1 ON testschema.Test (intField, floatField)",
          "COMMENT ON INDEX Test_1 IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[Test_1]'",
          ...
          "COMMENT ON TABLE testschema.Alternate IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[Alternate]'",
          "COMMENT ON COLUMN testschema.Alternate.id IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[id]/TYPE:[BIG_INTEGER]'",
          "COMMENT ON COLUMN testschema.Alternate.version IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[version]/TYPE:[INTEGER]'",
          "COMMENT ON COLUMN testschema.Alternate.stringField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[stringField]/TYPE:[STRING]'",
          "CREATE INDEX Alternate_1 ON testschema.Alternate (stringField)",
          "COMMENT ON INDEX Alternate_1 IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[Alternate_1]'",
          ...
          "COMMENT ON TABLE testschema.NonNull IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[NonNull]'",
          "COMMENT ON COLUMN testschema.NonNull.id IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[id]/TYPE:[BIG_INTEGER]'",
          "COMMENT ON COLUMN testschema.NonNull.version IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[version]/TYPE:[INTEGER]'",
          "COMMENT ON COLUMN testschema.NonNull.stringField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[stringField]/TYPE:[STRING]'",
          "COMMENT ON COLUMN testschema.NonNull.intField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[intField]/TYPE:[DECIMAL]'",
          "COMMENT ON COLUMN testschema.NonNull.booleanField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[booleanField]/TYPE:[BOOLEAN]'",
          "COMMENT ON COLUMN testschema.NonNull.dateField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[dateField]/TYPE:[DATE]'",
          "COMMENT ON COLUMN testschema.NonNull.blobField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[blobField]/TYPE:[BLOB]'",
          ...
          "COMMENT ON TABLE testschema.CompositePrimaryKey IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[CompositePrimaryKey]'",
          "COMMENT ON COLUMN testschema.CompositePrimaryKey.id IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[id]/TYPE:[BIG_INTEGER]'",
          "COMMENT ON COLUMN testschema.CompositePrimaryKey.version IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[version]/TYPE:[INTEGER]'",
          "COMMENT ON COLUMN testschema.CompositePrimaryKey.stringField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[stringField]/TYPE:[STRING]'",
          "COMMENT ON COLUMN testschema.CompositePrimaryKey.secondPrimaryKey IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[secondPrimaryKey]/TYPE:[STRING]'",
          ...
          "COMMENT ON TABLE testschema.AutoNumber IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[AutoNumber]'",
          "COMMENT ON COLUMN testschema.AutoNumber.intField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[intField]/TYPE:[BIG_INTEGER]/AUTONUMSTART:[5]'");
  }
  ...
  protected List<String> expectedCreateTemporaryTableStatements() {
    return Arrays
        .asList(
            ...
            "COMMENT ON TABLE TempTest IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[TempTest]'",
            "COMMENT ON COLUMN TempTest.id IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[id]/TYPE:[BIG_INTEGER]'",
            "COMMENT ON COLUMN TempTest.version IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[version]/TYPE:[INTEGER]'",
            "COMMENT ON COLUMN TempTest.stringField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[stringField]/TYPE:[STRING]'",
            "COMMENT ON COLUMN TempTest.intField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[intField]/TYPE:[INTEGER]'",
            "COMMENT ON COLUMN TempTest.floatField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[floatField]/TYPE:[DECIMAL]'",
            "COMMENT ON COLUMN TempTest.dateField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[dateField]/TYPE:[DATE]'",
            "COMMENT ON COLUMN TempTest.booleanField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[booleanField]/TYPE:[BOOLEAN]'",
            "COMMENT ON COLUMN TempTest.charField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[charField]/TYPE:[STRING]'",
            "COMMENT ON COLUMN TempTest.blobField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[blobField]/TYPE:[BLOB]'",
            "COMMENT ON COLUMN TempTest.bigIntegerField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[bigIntegerField]/TYPE:[BIG_INTEGER]'",
            "COMMENT ON COLUMN TempTest.clobField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[clobField]/TYPE:[CLOB]'",
            "CREATE UNIQUE INDEX TempTest_NK ON TempTest (stringField)",
            "COMMENT ON INDEX TempTest_NK IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[TempTest_NK]'",
            "CREATE INDEX TempTest_1 ON TempTest (intField, floatField)",
            "COMMENT ON INDEX TempTest_1 IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[TempTest_1]'",
            ...
            "COMMENT ON TABLE TempAlternate IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[TempAlternate]'",
            "COMMENT ON COLUMN TempAlternate.id IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[id]/TYPE:[BIG_INTEGER]'",
            "COMMENT ON COLUMN TempAlternate.version IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[version]/TYPE:[INTEGER]'",
            "COMMENT ON COLUMN TempAlternate.stringField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[stringField]/TYPE:[STRING]'",
            "CREATE INDEX TempAlternate_1 ON TempAlternate (stringField)",
            "COMMENT ON INDEX TempAlternate_1 IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[TempAlternate_1]'",
            ...
            "COMMENT ON TABLE TempNonNull IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[TempNonNull]'",
            "COMMENT ON COLUMN TempNonNull.id IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[id]/TYPE:[BIG_INTEGER]'",
            "COMMENT ON COLUMN TempNonNull.version IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[version]/TYPE:[INTEGER]'",
            "COMMENT ON COLUMN TempNonNull.stringField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[stringField]/TYPE:[STRING]'",
            "COMMENT ON COLUMN TempNonNull.intField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[intField]/TYPE:[DECIMAL]'",
            "COMMENT ON COLUMN TempNonNull.booleanField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[booleanField]/TYPE:[BOOLEAN]'",
            "COMMENT ON COLUMN TempNonNull.dateField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[dateField]/TYPE:[DATE]'",
            "COMMENT ON COLUMN TempNonNull.blobField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[blobField]/TYPE:[BLOB]'");
  }
  ...
  protected List<String> expectedCreateTableStatementsWithLongTableName() {
    return Arrays
        .asList("CREATE TABLE testschema."
            ...
            "COMMENT ON TABLE testschema.tableWithANameThatExceedsTwentySevenCharactersToMakeSureSchemaNameDoesNotGetFactoredIntoOracleNameTruncation IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[tableWithANameThatExceedsTwentySevenCharactersToMakeSureSchemaNameDoesNotGetFactoredIntoOracleNameTruncation]'",
            "COMMENT ON COLUMN testschema.tableWithANameThatExceedsTwentySevenCharactersToMakeSureSchemaNameDoesNotGetFactoredIntoOracleNameTruncation.id IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[id]/TYPE:[BIG_INTEGER]'",
            "COMMENT ON COLUMN testschema.tableWithANameThatExceedsTwentySevenCharactersToMakeSureSchemaNameDoesNotGetFactoredIntoOracleNameTruncation.version IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[version]/TYPE:[INTEGER]'",
            "COMMENT ON COLUMN testschema.tableWithANameThatExceedsTwentySevenCharactersToMakeSureSchemaNameDoesNotGetFactoredIntoOracleNameTruncation.stringField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[stringField]/TYPE:[STRING]'",
            "COMMENT ON COLUMN testschema.tableWithANameThatExceedsTwentySevenCharactersToMakeSureSchemaNameDoesNotGetFactoredIntoOracleNameTruncation.intField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[intField]/TYPE:[DECIMAL]'",
            "COMMENT ON COLUMN testschema.tableWithANameThatExceedsTwentySevenCharactersToMakeSureSchemaNameDoesNotGetFactoredIntoOracleNameTruncation.floatField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[floatField]/TYPE:[DECIMAL]'",
            "COMMENT ON COLUMN testschema.tableWithANameThatExceedsTwentySevenCharactersToMakeSureSchemaNameDoesNotGetFactoredIntoOracleNameTruncation.dateField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[dateField]/TYPE:[DATE]'",
            "COMMENT ON COLUMN testschema.tableWithANameThatExceedsTwentySevenCharactersToMakeSureSchemaNameDoesNotGetFactoredIntoOracleNameTruncation.booleanField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[booleanField]/TYPE:[BOOLEAN]'",
            "COMMENT ON COLUMN testschema.tableWithANameThatExceedsTwentySevenCharactersToMakeSureSchemaNameDoesNotGetFactoredIntoOracleNameTruncation.charField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[charField]/TYPE:[STRING]'",
  ...
  protected List<String> expectedAlterTableAddBlobColumnStatement() {
    return Arrays.asList("ALTER TABLE testschema.Test ADD COLUMN blobField_new BYTEA NULL",
        "COMMENT ON COLUMN testschema.Test.blobField_new IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[blobField_new]/TYPE:[BLOB]'");
  }
  ...
  protected List<String> expectedAlterTableAddBooleanColumnStatement() {
    return Arrays.asList("ALTER TABLE testschema.Test ADD COLUMN booleanField_new BOOLEAN NULL",
        "COMMENT ON COLUMN testschema.Test.booleanField_new IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[booleanField_new]/TYPE:[BOOLEAN]'");
  }
  ...
  protected List<String> expectedAlterTableAddStringColumnStatement() {
    return Arrays.asList("ALTER TABLE testschema.Test ADD COLUMN stringField_new VARCHAR(6) COLLATE \"POSIX\" NULL",
        "COMMENT ON COLUMN testschema.Test.stringField_new IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[stringField_new]/TYPE:[STRING]'");
  }
  ...
  protected List<String> expectedAlterTableAddIntegerColumnStatement() {
    return Arrays.asList("ALTER TABLE testschema.Test ADD COLUMN intField_new INTEGER NULL",
        "COMMENT ON COLUMN testschema.Test.intField_new IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[intField_new]/TYPE:[INTEGER]'");
  }
  ...
  protected List<String> expectedAlterTableAddDateColumnStatement() {
    return Arrays.asList("ALTER TABLE testschema.Test ADD COLUMN dateField_new DATE NULL",
        "COMMENT ON COLUMN testschema.Test.dateField_new IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[dateField_new]/TYPE:[DATE]'");
  }
  ...
  protected List<String> expectedAlterTableAddDecimalColumnStatement() {
    return Arrays.asList("ALTER TABLE testschema.Test ADD COLUMN floatField_new DECIMAL(6,3) NULL",
        "COMMENT ON COLUMN testschema.Test.floatField_new IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[floatField_new]/TYPE:[DECIMAL]'");
  }
  ...
  protected List<String> expectedAlterTableAddBigIntegerColumnStatement() {
    return Arrays.asList("ALTER TABLE testschema.Test ADD COLUMN bigIntegerField_new NUMERIC(19) NULL",
        "COMMENT ON COLUMN testschema.Test.bigIntegerField_new IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[bigIntegerField_new]/TYPE:[BIG_INTEGER]'");
  }
  ...
  protected List<String> expectedAddIndexStatementsOnSingleColumn() {
    return Arrays.asList("CREATE INDEX indexName ON testschema.Test (id)",
                         "COMMENT ON INDEX indexName IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[indexName]'");
  }
  ...
  protected List<String> expectedAlterPrimaryKeyColumnStatements() {
    return Arrays.asList(
        ...
        "COMMENT ON COLUMN testschema.Test.renamedId IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[renamedId]/TYPE:[BIG_INTEGER]'"
    );
  }
  ...
  protected List<String> expectedAlterColumnRenamingAndChangingNullability() {
    return Arrays.asList("ALTER TABLE testschema.Other RENAME floatField TO blahField",
        ...
        "COMMENT ON COLUMN testschema.Other.blahField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[blahField]/TYPE:[DECIMAL]'"
      );
  }
  ...
  protected List<String> expectedAlterTableAddStringColumnWithDefaultStatement() {
    return Arrays.asList("ALTER TABLE testschema.Test ADD COLUMN stringField_with_default VARCHAR(6) COLLATE \"POSIX\" DEFAULT 'N' NOT NULL",
        "COMMENT ON COLUMN testschema.Test.stringField_with_default IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[stringField_with_default]/TYPE:[STRING]'");
  }
  ...
  protected List<String> expectedCreateViewStatements() {
    return Arrays.asList("CREATE VIEW " + tableName("TestView") + " AS (SELECT stringField FROM " + tableName("Test") + " WHERE (stringField = 'blah'))",
                         "COMMENT ON VIEW TestView IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[TestView]'");
  }
  ...
  protected List<String> expectedRenameTableStatements() {
    return ImmutableList.of(
      ...
      "COMMENT ON INDEX Renamed_pk IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[Renamed_pk]'",
      "COMMENT ON TABLE testschema.Renamed IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[Renamed]'");
  }
  ...
  protected List<String> getRenamingTableWithLongNameStatements() {
    return ImmutableList.of(
      ...
      "COMMENT ON INDEX Blah_pk IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[Blah_pk]'",
      "COMMENT ON TABLE testschema.Blah IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[Blah]'"
        );
  }
  ...
  protected List<String> expectedRenameIndexStatements() {
    return ImmutableList.of("ALTER INDEX testschema.Test_1 RENAME TO Test_2",
                            "COMMENT ON INDEX Test_2 IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[Test_2]'");
  }
  ...
  protected List<String> expectedRenameTempIndexStatements() {
    return ImmutableList.of("ALTER INDEX TempTest_1 RENAME TO TempTest_2",
                            "COMMENT ON INDEX TempTest_2 IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[TempTest_2]'");
  }
  ...
  protected List<String> expectedAddTableFromStatements() {
    return ImmutableList.of(
      ...
      "COMMENT ON TABLE testschema.SomeTable IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[SomeTable]'",
      "COMMENT ON COLUMN testschema.SomeTable.someField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[someField]/TYPE:[STRING]'",
      "COMMENT ON COLUMN testschema.SomeTable.otherField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[otherField]/TYPE:[DECIMAL]'",
      "CREATE INDEX SomeTable_1 ON testschema.SomeTable (otherField)",
      "COMMENT ON INDEX SomeTable_1 IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[SomeTable_1]'",
  ...
  protected List<String> expectedReplaceTableFromStatements() {
    return ImmutableList.of(
        ...
        "COMMENT ON TABLE testschema.tmp_SomeTable IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[tmp_SomeTable]'",
        "COMMENT ON COLUMN testschema.tmp_SomeTable.someField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[someField]/TYPE:[STRING]'",
        "COMMENT ON COLUMN testschema.tmp_SomeTable.otherField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[otherField]/TYPE:[DECIMAL]'",
        ...
        "COMMENT ON INDEX SomeTable_pk IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[SomeTable_pk]'",
        "COMMENT ON TABLE testschema.SomeTable IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[SomeTable]'",
        "CREATE INDEX SomeTable_1 ON testschema.SomeTable (otherField)",
        "COMMENT ON INDEX SomeTable_1 IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[SomeTable_1]'"
    );
  ...
  protected List<String> expectedReplaceTableWithAutonumber() {
    return ImmutableList.of(
        ...
        "COMMENT ON TABLE testschema.tmp_SomeTable IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[tmp_SomeTable]'",
        "COMMENT ON COLUMN testschema.tmp_SomeTable.someField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[someField]/TYPE:[STRING]'",
        "COMMENT ON COLUMN testschema.tmp_SomeTable.otherField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[otherField]/TYPE:[DECIMAL]/AUTONUMSTART:[1]'",
        "COMMENT ON COLUMN testschema.tmp_SomeTable.thirdField IS 'REALNAME:[thirdField]/TYPE:[DECIMAL]'",
        "DROP TABLE testschema.SomeTable CASCADE",
        "ALTER TABLE testschema.tmp_SomeTable RENAME TO SomeTable",
        "ALTER INDEX testschema.tmp_SomeTable_pk RENAME TO SomeTable_pk",
  ...
  protected List<String> expectedAlterColumnChangingLengthAndCase() {
    return Arrays.asList("ALTER TABLE testschema.Other ALTER COLUMN FloatField TYPE DECIMAL(20,3)",
        "COMMENT ON COLUMN testschema.Other.FloatField IS '"+RedshiftDialect.REAL_NAME_COMMENT_LABEL+":[FloatField]/TYPE:[DECIMAL]'");
  }
