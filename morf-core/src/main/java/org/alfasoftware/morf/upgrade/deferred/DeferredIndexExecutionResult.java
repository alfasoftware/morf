...
/**
 * Summary of the outcome of a deferred index execution run.
 *
 * @author Copyright (c) Alfa Financial Software Limited. 2026
 */
public final class DeferredIndexExecutionResult {
   ...
   */
  public DeferredIndexExecutionResult(int completedCount, int failedCount) {
