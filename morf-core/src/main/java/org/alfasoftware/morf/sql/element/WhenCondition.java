 ...
 */
public class WhenCondition implements Driver, DeepCopyableWithTransformation<WhenCondition, Builder<WhenCondition>>, TableDiscoverable {
  ...
  public void discoverTables(DiscoveredTables discoveredTables) {
    if(value != null) {
      value.discoverTables(discoveredTables);
    }
    if(criterion != null) {
