...
public class TestDeleteStatementDeepCopyContract extends AbstractShallowAndDeepCopyableTest<DeleteStatement> {
  ...
  public static List<Object[]> data() {
    return Arrays.asList(
      testCase(() -> SqlUtils.delete(TABLE_1)),
      testCase(() -> SqlUtils.delete(TABLE_2)),
      testCase(() -> SqlUtils.delete(TABLE_1).where(CRITERION_1)),
      testCase(() -> SqlUtils.delete(TABLE_1).where(CRITERION_2))
    );
  }
