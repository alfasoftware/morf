...
public class TestTruncateStatementDeepCopyContract extends AbstractDeepCopyableTest<TruncateStatement> {
  ...
  public static List<Object[]> data() {
    return Arrays.asList(
      testCase(() -> truncate(TABLE_1)),
      testCase(() -> truncate(TABLE_2))
    );
  }
}