 ...
 */
@Sequence(200100)
@UUID("89c66a20-2578-11e0-ac64-0800200c9a66")
public final class AddGrams extends UpgradeStepTest {
  ...
  public void execute(SchemaEditor schema, DataEditor data) {
    schema.addColumn("Scone", column("grams", DataType.DECIMAL).nullable(),
        new FieldLiteral(0d));
  }
}