...
public class TestGraphBasedUpgradeBuilder {
   ...
   * the deferred index infrastructure exists before deferred index operations
   * are executed.
   */
  @Test
  ...
  /**
   * Verify that two steps using deferred indexes on different tables
  ...
  /**
   * Test step simulating a user of deferred index on table Product.
   */
  @Sequence(100L)
  static class DeferredUser extends U1 {}

  /**
   * Test step simulating a user of deferred index on table Customer.
   */
  @Sequence(101L)
