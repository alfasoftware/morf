...
/**
 * A dummy 5.0.10 (number 2) upgrade step.
 *
...
public class UpgradeStep5010Two implements UpgradeStep {
   ...
   * {@inheritDoc}
   *
   * @see org.alfasoftware.morf.upgrade.UpgradeStep#execute(org.alfasoftware.morf.upgrade.SchemaEditor,
   *      org.alfasoftware.morf.upgrade.DataEditor)
   */
  @Override
