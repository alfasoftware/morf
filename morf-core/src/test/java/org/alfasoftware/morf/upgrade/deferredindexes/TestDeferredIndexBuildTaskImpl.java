...
public class TestDeferredIndexBuildTaskImpl {
  ...
  public void setUp() throws SQLException {
    ...
    task = new DeferredIndexBuildTaskImpl(rowWith(DeferredIndexStatus.PENDING, 0), connectionResources, dao);
  }
  ...
  public void testSnapshotGettersExposeRowStateAtConstructionTime() {
    ...
    assertEquals(DeferredIndexStatus.FAILED, t.getStatus());
  ...
  public void testSnapshotGettersErrorMessageEmptyWhenNeverFailed() {
    DeferredIndex row = rowWith(DeferredIndexStatus.PENDING, 0);
