...
public class TestNuoDBDialect extends AbstractSqlDialectTest {
  ...
  protected List<String> expectedDropTables() {
    return Arrays.asList("DROP TABLE SCM.Test", "DROP TABLE SCM.Other");
  }
  ...
  protected List<String> expectedDropTablesWithParameters() {
    return Arrays.asList("DROP TABLE IF EXISTS SCM.Test CASCADE", "DROP TABLE IF EXISTS SCM.Other CASCADE");
  }
...
//  throw new RuntimeException("need to implement");    //FIXME Nuo support in progress
  ...
  protected List<String> expectedReplaceTableFromStatements() {
    return ImmutableList.of(
        "CREATE TABLE SCM.tmp_SomeTable (someField VARCHAR(3) NOT NULL, otherField DECIMAL(3,0) NOT NULL, thirdField DECIMAL(5,0) NOT NULL, PRIMARY KEY (someField))",
        "INSERT INTO SCM.tmp_SomeTable SELECT someField, otherField, thirdField FROM SCM.SomeTable",
        "DROP TABLE SCM.SomeTable CASCADE",
        "DROP INDEX IF EXISTS SCM.\"TMP_SOMETABLE..PRIMARY_KEY\"",
        "ALTER TABLE SCM.tmp_SomeTable RENAME TO SCM.SomeTable",
  ...
  protected List<String> expectedReplaceTableWithAutonumber() {
    return ImmutableList.of(
        "DROP SEQUENCE IF EXISTS SCM.tmp_SomeTable_IDS_1",
        "CREATE SEQUENCE SCM.tmp_SomeTable_IDS_1 START WITH 1",
        "CREATE TABLE SCM.tmp_SomeTable (someField VARCHAR(3) NOT NULL, otherField DECIMAL(3,0) GENERATED BY DEFAULT AS IDENTITY(tmp_SomeTable_IDS_1), PRIMARY KEY (someField))",
        "INSERT INTO SCM.tmp_SomeTable SELECT someField, otherField FROM SCM.SomeTable",
        "DROP TABLE SCM.SomeTable CASCADE",
        "DROP INDEX IF EXISTS SCM.\"TMP_SOMETABLE..PRIMARY_KEY\"",
        "ALTER TABLE SCM.tmp_SomeTable RENAME TO SCM.SomeTable",
        "ALTER TABLE SCM.SomeTable ADD PRIMARY KEY (someField)",
