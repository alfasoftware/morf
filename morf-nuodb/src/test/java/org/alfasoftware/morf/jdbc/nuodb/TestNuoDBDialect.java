...
//  throw new RuntimeException("need to implement");    //FIXME Nuo support in progress
  ...
  protected List<String> expectedReplaceTableWithAutonumber() {
    return ImmutableList.of(
        "DROP SEQUENCE IF EXISTS SCM.SomeTable2_IDS_1",
        "CREATE SEQUENCE SCM.SomeTable2_IDS_1 START WITH 1",
        "CREATE TABLE SCM.SomeTable2 (someField VARCHAR(3) NOT NULL, otherField DECIMAL(3,0) GENERATED BY DEFAULT AS IDENTITY(SomeTable2_IDS_1), PRIMARY KEY (someField))",
        "INSERT INTO SCM.SomeTable2 SELECT someField, otherField FROM SCM.SomeTable",
        "DROP TABLE SCM.SomeTable CASCADE",
        "DROP INDEX IF EXISTS SCM.\"SOMETABLE2..PRIMARY_KEY\"",
        "ALTER TABLE SCM.SomeTable2 RENAME TO SCM.SomeTable",
