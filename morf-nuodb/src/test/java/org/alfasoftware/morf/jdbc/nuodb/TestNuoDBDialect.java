...
//  throw new RuntimeException("need to implement");    //FIXME Nuo support in progress
  ...
  protected List<String> expectedReplaceTableFromStatements() {
    return ImmutableList.of(
        ...
        "INSERT INTO SCM.tmp_SomeTable SELECT someField, otherField, CAST(thirdField AS DECIMAL(5,0)) AS thirdField FROM SCM.OtherTable",
  ...
  protected List<String> expectedReplaceTableWithAutonumber() {
    return ImmutableList.of(
        ...
        "CREATE TABLE SCM.tmp_SomeTable (someField VARCHAR(3) NOT NULL, otherField DECIMAL(3,0) GENERATED BY DEFAULT AS IDENTITY(tmp_SomeTable_IDS_1), thirdField DECIMAL(5,0) NOT NULL, PRIMARY KEY (someField))",
        "INSERT INTO SCM.tmp_SomeTable SELECT someField, otherField, CAST(thirdField AS DECIMAL(5,0)) AS thirdField FROM SCM.OtherTable",
        "DROP TABLE SCM.SomeTable CASCADE",
        "DROP INDEX IF EXISTS SCM.\"TMP_SOMETABLE..PRIMARY_KEY\"",
        "ALTER TABLE SCM.tmp_SomeTable RENAME TO SCM.SomeTable",
