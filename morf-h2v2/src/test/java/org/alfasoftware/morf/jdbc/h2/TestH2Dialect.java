...
public class TestH2Dialect extends AbstractSqlDialectTest {
  ...
  protected String expectedMergeWithUpdateWhereClause() {
    return "MERGE INTO "+TEST_SCHEMA+".foo"
        + " USING (SELECT 12345 AS id, 1004 AS typeId, CAST('2025-04-20' AS VARCHAR(10)) AS eventDate, 5.00001 AS rate, CAST('important rate' AS VARCHAR(14)) AS description, 43037 AS sequenceId FROM dual) xmergesource"
  ...
  protected String expectedHash() {
    return "LEFT(RAWTOHEX(HASH('SHA-256', CONCAT(10, 2))), 5)";
  }
