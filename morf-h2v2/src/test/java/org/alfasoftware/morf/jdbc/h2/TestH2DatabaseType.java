...
public class TestH2DatabaseType {
  ...
  public void testFormatJdbcUrl() {
    String suffix = ";DB_CLOSE_DELAY=-1;DEFAULT_LOCK_TIMEOUT=150000;LOB_TIMEOUT=2000;NON_KEYWORDS=YEAR,MONTH";
    ...
    assertEquals("jdbc:h2:mem:data;DB_CLOSE_DELAY=-1;DEFAULT_LOCK_TIMEOUT=150000;LOB_TIMEOUT=2000;NON_KEYWORDS=YEAR,MONTH", databaseType.formatJdbcUrl(jdbcUrlElementBuilder().withHost("localhost").withDatabaseName("data").build()));
  }
