...
public final class H2 extends AbstractDatabaseType {
  ...
  public String formatJdbcUrl(JdbcUrlElements jdbcUrlElements) {
    ...
    // NON_KEYWORDS=YEAR allows year to be used a table or column name unquoted
    builder.append(";DB_CLOSE_DELAY=-1;DEFAULT_LOCK_TIMEOUT=150000;LOB_TIMEOUT=2000;MV_STORE=TRUE;NON_KEYWORDS=YEAR");
