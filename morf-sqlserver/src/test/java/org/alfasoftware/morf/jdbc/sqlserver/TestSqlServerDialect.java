  ...
  protected List<String> expectedCreateTableStatements() {
    return Arrays
        .asList(
          ...
          "CREATE TABLE TESTSCHEMA.MeasurementHash ([intField] NUMERIC(8,0) NOT NULL, [dateField] DATE NOT NULL, [stringField] NVARCHAR(3) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL)"
            );
  }
