...
public class TestSqlServerDialect extends AbstractSqlDialectTest {
  ...
  protected List<String> expectedReplaceTableFromStatements() {
    return ImmutableList.of(
        "CREATE TABLE TESTSCHEMA.SomeTable2 ([someField] NVARCHAR(3) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL, [otherField] NUMERIC(3,0) NOT NULL, CONSTRAINT [SomeTable2_PK] PRIMARY KEY ([someField]))",
