  ...
  protected List<String> expectedCreateTableStatements() {
    return Arrays
        .asList(
          ...
          "CREATE TABLE "+TEST_SCHEMA+".Measurement (intField DECIMAL(8,0) NOT NULL, dateField DATE NOT NULL, stringField VARCHAR(3) NOT NULL)",
          "CREATE TABLE "+TEST_SCHEMA+".MeasurementHash (intField DECIMAL(8,0) NOT NULL, dateField DATE NOT NULL, stringField VARCHAR(3) NOT NULL)"
        );
  }
