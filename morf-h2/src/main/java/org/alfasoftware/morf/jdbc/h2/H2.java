...
public final class H2 extends AbstractDatabaseType {
  ...
  public String formatJdbcUrl(JdbcUrlElements jdbcUrlElements) {
    ...
    // Note that when using MV_STORE=TRUE the MVCC will automatically be set to TRUE
    builder.append(";DB_CLOSE_DELAY=-1;MVCC=TRUE;DEFAULT_LOCK_TIMEOUT=60000;LOB_TIMEOUT=0;MV_STORE=TRUE");
